...
||****************** 开始使用 ********************`n
|| 首先：新建虚拟桌面，按快捷键“Ctrl + Win + D”即可新建一个虚拟桌面！`n

||****************** 功能说明 ********************`n
|| 1. 脚本总开关（注意看任务栏图标变化）：ALT + Win + P`n
|| 2. 查看帮助：ALT + Win + H `n
|| 3. 按住鼠标右键快速左右滑动：切换虚拟桌面。`n
|| 4. 按住鼠标右键快速向上滑：切换显示任务视图。`n
|| 5. 按住鼠标右键快速向下滑：切换显示桌面。`n
|| 6. 彩蛋：ALT + Win + L`n`n
|| 版本：1.1
...
!#H::MsgBox
|| 欢迎使用ARB! 一款为Windows 10定制的虚拟桌面鼠标右键手势工具！`n`n
||****************** 开始使用 ********************`n
...
|| 源代码：https://github.com/hansenwangvip/arb`n
...
if (State = 0) {
	...
	SetTimer, HideCloseTrayTip, -2000
	HideCloseTrayTip() {
			if SubStr(A_OSVersion,1,3) = "10." {
					Menu Tray, NoIcon
					Sleep 200  ; It may be necessary to adjust this sleep.
